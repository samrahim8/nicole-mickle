              ...
              <Stagger className="space-y-8" staggerDelay={0.08}>
                <StaggerChild>
                  <div className="border-l-2 border-[#1B3A2D]/20 pl-8">
                    ...
                    <p className="text-[14px] text-neutral-500 leading-[1.8]">The sales agent at the model home is employed by the builder. They&apos;re trained to sell the builder&apos;s inventory at the builder&apos;s price with the builder&apos;s preferred lender. Your own agent reviews the contract, negotiates on your behalf, and costs you nothing.</p>
                  </div>
                </StaggerChild>
                <StaggerChild>
                  <div className="border-l-2 border-[#1B3A2D]/20 pl-8">
                    <h3 className="text-base font-medium text-charcoal mb-2">Not all upgrades add value</h3>
                    <p className="text-[14px] text-neutral-500 leading-[1.8]">Structural upgrades (electrical, plumbing rough-ins, expanded garages) are worth the cost because they&apos;re nearly impossible to add later. Cosmetic upgrades like premium paint or lighting fixtures are often cheaper to do yourself after closing.</p>
                  </div>
                </StaggerChild>
                <StaggerChild>
                  <div className="border-l-2 border-[#1B3A2D]/20 pl-8">
                    <h3 className="text-base font-medium text-charcoal mb-2">The base price isn&apos;t the only number</h3>
                    <p className="text-[14px] text-neutral-500 leading-[1.8]">Builders rarely lower the base price, but there&apos;s often room to negotiate closing cost credits, upgrade packages, and rate buydowns. The best leverage comes during pre-construction and community closeout phases.</p>
                  </div>
                </StaggerChild>
                <StaggerChild>
                  <div className="border-l-2 border-[#1B3A2D]/20 pl-8">
                    <h3 className="text-base font-medium text-charcoal mb-2">Timelines will shift</h3>
                    <p className="text-[14px] text-neutral-500 leading-[1.8]">Most production homes take 6-12 months from contract to close. Permitting, weather, and supply chain issues cause delays. Having an agent who monitors the build schedule and holds the builder accountable makes a real difference.</p>
                  </div>
                </StaggerChild>
              </Stagger>
            </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-[15px] text-neutral-500 mb-10">I know which builders deliver quality, which upgrades add value, and how to negotiate the best deal.</p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link href="/contact" className="group inline-flex items-center gap-2 text-[13px] tracking-wide font-medium text-[#1B3A2D] border-b border-[#1B3A2D] pb-0.5 hover:border-[#234B39] hover:text-[#234B39] transition-all duration-300">
                  Discuss your build
                ...
                <span className="text-neutral-200 hidden sm:block">|</span>
                <a href="https://iorlandorealestate.com" target="_blank" rel="noopener noreferrer" className="text-[13px] tracking-wide text-neutral-400 hover:text-charcoal transition-colors duration-300">Search new construction homes</a>
              </div>
            </div>
          </FadeIn>
        </div>
